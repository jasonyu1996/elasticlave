...
int main(int argc, char* argv[])
{
  ...
  enclave1.init("icall-proxy-3-baseline-s.eapp_riscv", "eyrie-rt", params);

  enclave2.init("icall-proxy-3-baseline-c.eapp_riscv", "eyrie-rt", params);

  enclave3.init("icall-proxy-3-baseline-p.eapp_riscv", "eyrie-rt", params);
