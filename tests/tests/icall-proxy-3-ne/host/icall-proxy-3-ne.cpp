...
int main(int argc, char* argv[])
{
  ...
  enclave1.init("icall-proxy-3-ne-s.eapp_riscv", "eyrie-rt", params);

  enclave2.init("icall-proxy-3-ne-c.eapp_riscv", "eyrie-rt", params);

  enclave3.init("icall-proxy-3-ne-p.eapp_riscv", "eyrie-rt", params);
